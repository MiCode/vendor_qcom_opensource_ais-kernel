...
#define CAM_DEFAULT_RATELIMIT_INTERVAL 5
#define CAM_DEFAULT_RATELIMIT_BURST 10
...
CAM_LOG_RL_CUSTOM(type, module_id, CAM_DEFAULT_RATELIMIT_INTERVAL, CAM_DEFAULT_RATELIMIT_BURST,  \
fmt, ##args)
